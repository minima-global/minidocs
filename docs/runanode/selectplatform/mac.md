...
Next, access your MiniDapp hub and **[setup your Incentive Program account](/docs/runanode/incentivesetup)** to start earning Rewards.
...
1. In Safari, go to **https://127.0.0.1:9004/**, click on **Show Details** then **Visit this website**
2. Go to **https://127.0.0.1:9003/** and repeat, you should see the MiniDapp System login page
3. Close **https://127.0.0.1:9004/**<br/><br/>
**Server**
...
:::note Port Mappings
**This creates a node on ports 7001-7004 on YOUR DESKTOP, this will be mapped to ports 9001-9004 in the Docker container.**
:::
...
Your backup will go to the **minimadocker8001** folder in your home directory.
