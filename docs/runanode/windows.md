...
1. Go to to https://127.0.0.1:9003/ or https://localhost:9003/ in your web browser
...
```
mds action:install file:C:\Users\YourName\Downloads\Terminal.mds.zip
```
...
```
{
  ...
  "params":{
    "action":"install",
    "file":"C:\\Users\\MyName\\Downloads\\Terminal.mds.zip"
  },
  "status":true,
  "response":{
    "installed":{
