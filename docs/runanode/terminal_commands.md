...
| runscript |**script:** |**clean:true** \| false <br/>**state:**{"port":"value",..} <br/>**prevstate:**{"port":"value",..} <br/>**globals:**{"@GLOBALVAR":"value",...} <br/>**signatures:**[" ",...] <br/>**extrascripts:**{"script":"scriptproof",...}  |Run a script with the defined parameters<br/>**clean** - clean the script<br/>**state** - JSON Object, state variable values for the script<br/>**prevstate** - JSON Object, previous state variables values for the coin <br/> **globals** -  JSON Object, global variable values for the script e.g. globals:{"@BLOCK":"101"} signatures: JSON Array <br/> **extrascripts** - JSON Object |
